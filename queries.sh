...
echo "$($PSQL "SELECT AVG(winner_goals + opponent_goals),16) FROM games")"
...
echo "$($PSQL "SELECT year, teams.name FROM games LEFT JOIN teams ON games.winner_id=teams.team_id WHERE round='Final'")"
